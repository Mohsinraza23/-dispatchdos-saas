...
const plans = [
  {
    ...
    pkr: 0,
    lookups: 30,
    features: ['30 lookups / month', 'All 30+ FMCSA fields', 'Risk score per carrier', 'Excel export'],
  ...
  },
  {
    ...
    pkr: 5300,
    lookups: 500,
    features: ['500 lookups / month', 'All 30+ FMCSA fields', 'Risk score per carrier', 'Excel + PDF export', 'Authority change alerts', 'Canada carriers'],
    missing: ['API access'],
    cta: 'Get Starter',
  ...
  },
  {
    ...
    pkr: 13700,
    lookups: Infinity,
    features: ['Unlimited lookups', 'All 30+ FMCSA fields', 'Risk score per carrier', 'Excel + PDF export', 'Authority change alerts', 'Canada carriers', 'API access'],
    missing: [],
    cta: 'Get Pro',
